...
<div class="layui-container">
    ...
    <header>
        ...
        <h4>收益明细</h4></header>
    <!--信息-->
    <div class="frozn mescroll"  id="mescroll">
        <!--搜索框-->
        <div class="pro-sous">
            <input type="search" value="${keywords}" id="keyword" placeholder="可输入关键字搜索"/>
    ...
    $(function(){
        ...
        function setListData(curPageData){
            ...
            for (var i = 0; i < curPageData.length; i++) {
                ...
                str+='<td>'+pd.BONUS_TYPE+'</td>';
                str+='<td>'+pd.TAG + pd.MONEY +'</td>';
                str+='<td>'+pd.SOURCE +'</td>';
        ...
        function getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
            ...
            var url;
            if (keyword != '') {
                url = 'front/to_profitPage?num=' + pageNum + "&size=" + pageSize + "&keywords=" + keyword;
            } else {
                url = 'front/to_profitPage?num=' + pageNum + "&size=" + pageSize;
            }
            $.ajax({
                url: url,
