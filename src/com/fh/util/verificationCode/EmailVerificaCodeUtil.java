...
public class EmailVerificaCodeUtil {
    ...
    //邮件编辑信息(仅需写上自己的)
    private static final String MAIL_FROM ="o1238888@qq.com";//邮件发送人
    private static final String MAIL_FROM_PASSWORD ="xxxxxxx";//邮件发送人授权码
    private static final String MAIL_SUBJECT_REGISTER ="测试【注册链接】";//邮件主题(注册链接)
    private static final String MAIL_SUBJECT_VERIFY_CODE ="巨邦网络的【邮箱验证码】";//邮件主题(邮箱验证码)
    private static final String MAIL_ORGANIZATION ="巨邦网络";//邮件组织
    private static final String MAIL_WEBSITE ="https://www.jbwl.com/";//组织主页
    private static final String MAIL_ORGANIZATION_LOGO ="http://www.bynrnews.com/new/qiye/upload/1563/admin/20190322/a67a1cd780a247f4aea2dc21d64df107.jpg";//网站logo
    private static final String MAIL_ORGANIZATION_QRCODE ="http://a4.qpic.cn/psb?/V110yGYF2cTov5/ZOjCpd6UqH0Me*f03USUjD5cUtb9bBeTjasA5H5QjoM!/m/dL8AAAAAAAAAnull&bo=CQM1AwAAAAARBww!&rf=photolist&t=5";//网站二维码图片
...
//        message.setText("<h1>hello</h1>");//纯文本
    ...
    private static String prettyLayout(String websiteName,String principal,String principalImage,String business,String...qrCode){
        return mailHead(websiteName,principal,principalImage,"323","48")+
                business +
