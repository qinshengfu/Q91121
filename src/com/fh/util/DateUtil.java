...
public class DateUtil {
     ...
     * @return yyyy-MM-dd HH:mm:ss格式的时间
     */
    public static String getAddHourDate(String nowTine,String days) {
        Date date = Tools.str2Date(nowTine);
        int hoursInt = Integer.parseInt(days);
        Calendar canlendar = Calendar.getInstance(); // java.util包
        assert date != null;
        // 设置现在时间
        canlendar.setTime(date);
        canlendar.add(Calendar.HOUR_OF_DAY, hoursInt); // 日期减 如果不够减会将月变动
