...
<script type="text/javascript" charset="utf-8">
    ...
    $(function(){
        ...
        function getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
            ...
            var url = 'front/toFrozenPage?num=' + pageNum + "&size=" + pageSize;
            $.ajax({
                url: url,
