...
public class Const {
	...
	public static final String USER_FROZEN_TASK = "userFrozenTask"; 		// 用户打款时间 的定时任务名前缀，后缀是匹配订单ID
	public static final String DYNAMIC_REWARD_TASK = "dynamicRewardTask"; 		// 动态奖 的定时任务名前缀，后缀是冻结订单ID
	public static final String STATIC_REWARD_TASK = "staticRewardTask"; 		// 静态奖（本金+利息）的定时任务名前缀，后缀是冻结订单ID
	...
	public static final String APP_USER = "applicati_user";			//服务器缓存用户信息
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(static/front)).*";	//不对匹配该值的访问路径拦截（正则）
