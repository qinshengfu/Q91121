...
public class LoginController extends BaseController {
	...
	public ModelAndView defaultPage() throws Exception{
		...
		// 今日会员数
		pd.put("appDayUserCount", Integer.parseInt(appuserService.getAppDayUserCount("").get("appDayUserCount").toString()));
        // 累积排单金额统计
        pd.put("buyCount", Integer.parseInt(appuserService.getBuyCount("").get("buyCount").toString()));
        // 今日排单金额统计
        pd.put("dayBuyCount", Integer.parseInt(appuserService.getDayBuyCount("").get("dayBuyCount").toString()));
        // 累积提现金额统计
        pd.put("sellCount", Integer.parseInt(appuserService.getSellCount("").get("sellCount").toString()));
        // 今日提现金额统计
        pd.put("daySellCount", Integer.parseInt(appuserService.getDaySellCount("").get("daySellCount").toString()));
        // 累积匹配金额统计
        pd.put("matchCount", Integer.parseInt(appuserService.getMatchCount("").get("matchCount").toString()));
        // 今日匹配金额统计
        pd.put("dayMatchCount", Integer.parseInt(appuserService.getDayMatchCount("").get("dayMatchCount").toString()));
